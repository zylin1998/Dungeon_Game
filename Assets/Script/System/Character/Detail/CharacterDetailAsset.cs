...
namespace RoleSystem
{
    ...
    public class CharacterDetailAsset : PackableObject
    {
        #region Packed Class
        ...
        public class Pack : PackableObjectPack
        {
            ...
            public Pack(CharacterDetailAsset asset) 
            {
        ...
        public override void Initialized(IPackableHandler.BasicPack basicPack) 
        {
            ...
            {
                pack.UnPacked(this, delegate (CharacterDetailAsset packable)
                {
                    packable.SinglePhysical = pack.physical;
                    packable.SingleWeapon = pack.weapon;
                });
            }
        }
