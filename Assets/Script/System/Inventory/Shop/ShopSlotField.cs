...
{
    public class ShopSlotField : MonoBehaviour, ISlotFieldHandler<ItemPool.ItemStack>, ICategoryHandler, IPageStateHandler, INaviPanelCtrl
    {
        ...
        [SerializeField]
        private ISlotFieldHandler<ItemPool.ItemStack>.SlotDetail detail;
        [SerializeField]
        ...
        {
            this.NaviPanels = CustomContainer.GetContents<SelectableCollect>("Shop").ConvertAll(c => c as INaviPanel);
        }
